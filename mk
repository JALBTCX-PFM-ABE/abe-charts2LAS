...
if [ $SYS = "Linux" ]; then
    ...
    LIBRARIES="-L$PFM_LIB -lCHARTS -lproj -lnvutility -llas -lgdal -lxml2 -lpoppler -lGLU"
    export LD_LIBRARY_PATH=$PFM_LIB:$QTDIR/lib:$LD_LIBRARY_PATH
else
    DEFS="WIN32 NVWIN3X UINT32_C INT32_C"
    LIBRARIES="-L$PFM_LIB -lCHARTS -lproj -lnvutility -llas -lgdal -lxml2 -lpoppler -liconv"
